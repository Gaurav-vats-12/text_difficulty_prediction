...
def main():
    ...
    if not st.session_state['start']:
        ...
        with col2:
            st.image("https://raw.githubusercontent.com/vgentile98/text_difficulty_prediction/main/app/logo.jpeg", display: block; margin-left: auto; margin-right: auto; width: 40%;)
